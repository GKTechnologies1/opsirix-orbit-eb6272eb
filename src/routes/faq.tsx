...
const IMMIGRANT: QA[] = [
  ...
  { q: "Can Opsirix help H-1B or F-1 founders?", a: "Opsirix can help H-1B and F-1 founders with operational organization: document management, workflow setup, professional coordination, and readiness tracking. Opsirix does not advise on H-1B or F-1 status, work authorization, or immigration compliance. Those matters require a licensed immigration attorney." },
...
const SERVICES: QA[] = [
  { q: "What is Opsirix Vault?", a: "Opsirix Vault is the document organization system within the platform. It helps founders store, organize, and access formation documents, operating agreements, attorney correspondence, financial records, and other business documents in one structured location.", link: { to: "/platform/vault", label: "Learn more" } },
  ...
  { q: "What is Opsirix Grid?", a: "Opsirix Grid is the monthly operational readiness scoring system. It measures your startup's health across ten areas on a structured scale. Your Grid score is delivered in your monthly Founder Status Report. The Grid score is an internal operational indicator, not a legal compliance certification.", link: { to: "/platform/grid", label: "Learn more" } },
  { q: "What is the Founder Status Report?", a: "The Founder Status Report is a monthly written summary delivered to every active Opsirix founder. It includes your current Grid score, what was completed this month, what is coming up next month, and any open action items. It gives you a clear operational picture every 30 days." },
];

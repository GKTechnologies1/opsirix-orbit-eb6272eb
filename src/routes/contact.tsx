  ...
  head: () => ({
    meta: [
      { title: "Book a Discovery Call | Opsirix Founder Operations" },
      {
        name: "description",
        content:
          "Schedule your free 30-minute Opsirix Discovery Call. Complete the founder intake form and we will contact you to discuss the right Opsirix path.",
      },
...
const INFO_ROWS = [
  { icon: "🕐", label: "WHAT HAPPENS NEXT", value: "We review your submission and contact you about next steps" },
      ...
      <div className="contact-grid">
        <div className="contact-left">
          ...
          <p className="contact-lead">
            Tell us about your situation. We'll review your intake and contact you to schedule your 30-minute Discovery Call.
          </p>
